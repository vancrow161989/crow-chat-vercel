  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen gap-6 px-6 ">
      ...
      <ul className="mt-3 ml-5 list-disc max-w-md text-muted-foreground space-y-2 mt-0">
        <li>
          <strong className="text-black"> Support Chatbot</strong> – A customer
          support chatbot for an imaginary theme park that answers questions
          about rides, tickets, dining, accommodations, and more.
        </li>
        <li>
